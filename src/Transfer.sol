...
contract Transfer {
  ...
  function transferERC721(
    ...
    (bool loggingSuccess, bytes memory loggingResult) = address(vaultAddress)
      .call(
        abi.encodeWithSignature(
          "logIncomingERC721(address,address,uint256,uint128)",
          _ownerAddress,
          _erc721Address,
          _erc721Id,
          _fee
  ...
  function transferERC20(
    ...
    require(msg.sender == EOA);
    (bool transferSuccess, bytes memory transferResult) = address(_erc20Address)
      .call(
        abi.encodeWithSignature(
          "transferFrom(address,address,uint256)",
          _ownerAddress,
    ...
    (bool loggingSuccess, bytes memory loggingResult) = address(vaultAddress)
      .call(
        abi.encodeWithSignature(
          "logIncomingERC20(address,address,uint256,uint128)",
          _ownerAddress,
          _erc20Address,
          _amount,
          _fee
